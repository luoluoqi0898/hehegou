...
import com.app.hehego.bean.ShoppingCart;
...
public class CartProvider {
    ...
    public void commit(){
        ...
        PreferencesUtils.putString(mContext, HehegoApplication.PREFERENCE_NAME, CART_JSON, JSONUtil.toJSON(carts));
    ...
    public  List<ShoppingCart> getDataFromLocal(){
        ...
        String json = PreferencesUtils.getString(mContext,HehegoApplication.PREFERENCE_NAME, CART_JSON);
